<template>
    <div class="model-stage">
        ...
        <div class="toy-car" :class="{ 'is-ready': generated }">
            <div class="car-roof"><div class="windshield"></div></div>
            <div class="car-body"><div class="headlight left"></div><div class="headlight right"></div></div>
        ...
        <div class="asset-status">
            ...
            <p v-else>{{ $t("image3d.uploadToGenerate") }}</p>
        </div>
    </div>
</template>
